...
export class DayPicker extends Component {
    ...
    static defaultProps = {
        ...
        navbarElement: < Navbar classNames = {
            classNames
        }
        />,
        captionElement: < Caption classNames = {
            classNames
        }
        />,
    };
    ...
    showPreviousMonth = callback => {
        ...
        const previousMonth = DateUtils.addMonths(
            this.state.currentMonth, -deltaMonths
        );
    ...
    renderTodayButton() {
        return ( <
            ...
            className = {
                this.props.classNames.todayButton
            }
            aria - label = {
